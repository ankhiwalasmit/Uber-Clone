...
const CaptainSignup = () => {
  ...
  return (
    <div className='py-5 px-5 h-screen flex flex-col justify-between'>
      ...
      <div>
        <p className='text-[10px] leading-tight'>This site is protected by reCAPTCHA and the <span className='underline'>Google Privacy Policy</span> and <span className='underline'>Terms and Service apply</span>.</p>
      </div>
    </div>
  )
}
